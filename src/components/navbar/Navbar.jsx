...
const Navbar = () => {
  const [show, setShow] = useState({ expand: false, show: "", popper: "" });
  ...
  const showDropmenue = () => {
    console.log("clicked");
    let change;
    // setShow({expand: !show.expand})
    switch (show.expand) {
      case true:
        change = { expand: false, show: "", popper: "" };
        break;

      default:
        change = { expand: true, show: "show", popper: "static" };
        break;
    }
        ...
        <nav className="navbar navbar-expand">
                  ...
                  <div className="header-message-list">
                    ...
                    <a className="dropdown-item" href="javascript:;">
                      <div className="d-flex align-items-center">
                        <div className="user-online">
                          <img
                            src="./src/assets/images/avatars/avatar-5.png"
                            className="msg-avatar"
                            alt="user avatar"
                          />
                        </div>
                    ...
                    <a className="dropdown-item" href="javascript:;">
                      <div className="d-flex align-items-center">
                        <div className="user-online">
                          <img
                            src="./src/assets/images/avatars/avatar-6.png"
                            className="msg-avatar"
                            alt="user avatar"
                          />
                        </div>
                    ...
                    <a className="dropdown-item" href="javascript:;">
                      <div className="d-flex align-items-center">
                        <div className="user-online">
                          <img
                            src="./src/assets/images/avatars/avatar-7.png"
                            className="msg-avatar"
                            alt="user avatar"
                          />
                        </div>
                    ...
                    <a className="dropdown-item" href="javascript:;">
                      <div className="d-flex align-items-center">
                        <div className="user-online">
                          <img
                            src="./src/assets/images/avatars/avatar-8.png"
                            className="msg-avatar"
                            alt="user avatar"
                          />
                        </div>
                    ...
                    <a className="dropdown-item" href="javascript:;">
                      <div className="d-flex align-items-center">
                        <div className="user-online">
                          <img
                            src="./src/assets/images/avatars/avatar-9.png"
                            className="msg-avatar"
                            alt="user avatar"
                          />
                        </div>
                    ...
                    <a className="dropdown-item" href="javascript:;">
                      <div className="d-flex align-items-center">
                        <div className="user-online">
                          <img
                            src="./src/assets/images/avatars/avatar-11.png"
                            className="msg-avatar"
                            alt="user avatar"
                          />
                        </div>
          ...
          <div className="user-box dropdown">
            <a
              ...
              role="button"
              data-bs-toggle="dropdown"
              aria-expanded={show.expand}
              onClick={() => showDropmenue()}
            >
              <img
                src="/src/assets/images/avatars/gen1.png"
                className="user-img"
                alt="user avatar"
              />
